...
class JavaSourcesSubjectFactoryTest {
    ...
    void generatesFileNamed() {
        assertAbout(javaSource())
                ...
                .compilesWithoutError()
                .and()
                .generatesFileNamed(CLASS_OUTPUT, "io.jbock.testing.compile", "Foo")
    ...
    void generatesFileNamed_failOnFileExistence() {
        AssertionError expected = Assertions.assertThrows(
                ...
                () -> assertAbout(javaSource())
                        ...
                        .compilesWithoutError()
                        .and()
                        .generatesFileNamed(CLASS_OUTPUT, "io.jbock.testing.compile", "Bogus")
                        .withContents("Bar".getBytes(UTF_8)));
        assertThat(expected)
                .factValue("expected to generate file")
                .isEqualTo("/io/jbock/testing/compile/Bogus");
